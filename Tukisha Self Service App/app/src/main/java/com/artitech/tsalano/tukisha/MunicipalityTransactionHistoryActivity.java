...
public class MunicipalityTransactionHistoryActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(MunicipalityTransactionHistoryActivity.this, MainTabProductActivity.class);
                startActivity(i);
            }
        });
    ...
    private void loadTransactionHistory(String startdate, String enddate) {
        ...
        client.get("https://munipoiapp.herokuapp.com/api/selfservice/munitransactionhistory?agentid=" + tukishaApplication.getAgentID() + "&startdate=" + startdate  + "&enddate=" + enddate, new AsyncHttpResponseHandler() {
            @Override
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    i.putExtra("vouchernumber", voucher.getVoucherNumber());
