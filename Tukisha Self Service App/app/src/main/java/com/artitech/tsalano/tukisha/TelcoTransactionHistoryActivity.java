...
public class TelcoTransactionHistoryActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(TelcoTransactionHistoryActivity.this, MainTabProductActivity.class);
                startActivity(i);
            }
        });
    ...
    private void loadTransactionHistory(String startdate, String enddate) {
        ...
        client.get("https://munipoiapp.herokuapp.com/api/selfservice/telcotransactionhistory?agentid=" + tukishaApplication.getAgentID() + "&startdate=" + startdate  + "&enddate=" + enddate, new AsyncHttpResponseHandler() {
            @Override
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            TelcoListAdapter adapter = new TelcoListAdapter(getApplicationContext(), R.layout.list_transaction_layout, R.id.item_ProductType, listItems);
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    i.putExtra("vouchernumber", transHistory.getVoucherNumber());
                                    i.putExtra("operator", transHistory.getProvider());
                                    i.putExtra("date", transHistory.getDateProcessed());
                                    i.putExtra("amount", transHistory.getAmount());
                                    i.putExtra("instructions", transHistory.getProductType());
