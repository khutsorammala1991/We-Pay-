...
public class EditDeleteBeneficiaries extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gohome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(EditDeleteBeneficiaries.this,MainTabProductActivity.class);
                startActivity(int1);
            }
        });
    ...
    public void onClick(View v) {
        ...
        new DatePickerDialog(EditDeleteBeneficiaries.this, this, myCalendar
                ...
                try {
                    ...
                    if (status == 200) {
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            BeneficiariesListAdopter adapter = new BeneficiariesListAdopter(getApplicationContext(), R.layout.list_transaction_layouteditdelete, R.id.item_ProductType, listItems);
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    i.putExtra("meternumber", dstv.getMeterNumber());
                                    startActivity(i);
