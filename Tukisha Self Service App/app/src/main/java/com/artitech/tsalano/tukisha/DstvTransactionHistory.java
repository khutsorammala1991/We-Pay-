...
public class DstvTransactionHistory extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(DstvTransactionHistory.this, MainTabProductActivity.class);
                startActivity(i);
            }
        });
    ...
    private void loadTransactionHistory(String startdate, String enddate) {
        ...
        client.get("https://munipoiapp.herokuapp.com/api/selfservice/dstvtransactionhistory?agentid=" + tukishaApplication.getAgentID() + "&startdate=" + startdate  + "&enddate=" + enddate, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int status, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (status == 200) {
                        ...
                        Gson gson = new Gson();
                        DSTVTransactionHistoryModel[] transactionHistoryModel = gson.fromJson(response, DSTVTransactionHistoryModel[].class);
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    Intent i = new Intent(DstvTransactionHistory.this, SendSMSActivity.class);
                                    i.putExtra("vouchernumber", voucher.getAccountNumber());
