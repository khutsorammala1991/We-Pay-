...
public class SelectBeneficiarysActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {

    protected static ArrayList<BeneficiariesModel> listItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.beneficiaries);
        ...
        gohome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(SelectBeneficiarysActivity.this,MainTabProductActivity.class);
                startActivity(int1);
            }
        });
    ...
    public void onClick(View v) {
        ...
        new DatePickerDialog(SelectBeneficiarysActivity.this, this, myCalendar
    ...
    private void loadTransactionHistory(String startdate, String enddate) {
        ...
        client.get("https://munipoiapp.herokuapp.com/api/selfservice/getbeneficiaries?agentid=" + tukishaApplication.getAgentID(), new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int status, Header[] headers, byte[] responseBody) {
                try {
                    ...
                    if (status == 200) {
                        ...
                        Gson gson = new Gson();
                        BeneficiariesModel[] transactionHistoryModel = gson.fromJson(response, BeneficiariesModel[].class);
                       ...
                       /* TransactionHistoryModel[] transactionHistoryModel = new TransactionHistoryModel[]{new TransactionHistoryModel("Relay", "1234567", "21 Aug 2017", "R200", "Clothing Account", "Foschini"),
                        ...
                        if (transactionHistoryModel.length > 0) {
                            ...
                            listItems = new ArrayList<BeneficiariesModel>();
                           ...
                           BeneficiariesListAdopter adapter = new BeneficiariesListAdopter(getApplicationContext(), R.layout.list_transaction_layout, R.id.item_ProductType, listItems);
                            ...
                            transactionListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView parent, View view,
                                    ...
                                    BeneficiariesModel dstv = (BeneficiariesModel) transactionListView.getItemAtPosition(position);

                                    Intent i = new Intent(getBaseContext(), DSTVActivity.class);
                                    i.putExtra("accountNumber", dstv.getMeterNumber());
                                    startActivity(i);
